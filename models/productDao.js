...
const getAllproductsByPriceDesc = async () => {
...
const getAllproductsByPriceAsc = async () => {
  return await prisma.$queryRaw`
    SELECT 
      p.id, 
      p.name, 
...
const getProductsByTypePriceDesc = async (typeNum) => {
  return await prisma.$queryRaw`
    SELECT 
      p.id, 
      p.name, 
...
const getProductsByTypePriceAsc = async (typeNum) => {
  return await prisma.$queryRaw`
    SELECT 
      p.id, 
      p.name, 
...
export {
  ...
  getProductsByTypePriceDesc,
  getProductsByTypePriceAsc,
  getTypeCategory,
};
